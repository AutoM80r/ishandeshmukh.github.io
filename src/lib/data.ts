export const HERO = {
  ...
  description:
    'I build things that move, sense, and react. From national competition robots to ABB industrial welding cells — driven by the idea that engineering should be creative, bold, and a little obsessive.',
  stats: [
    { value: '22', label: 'AIR · National Robotics' },
    { value: '4+', label: 'Yrs Building Systems' },
    { value: '2', label: 'Patents Pending' },
    { value: 'GET', label: "Tata Motors · Jul '26" },
  ],
}
...
export const RESUME = {
  experience: [
    ...
    },
    {
      ...
      points: [
        'Developed an automated robotic welding cell using an ABB IRB 2600 robot with gantry, positioner, and IRC5 controller',
    ...
    {
      role: 'Robotics Head',
      org: 'IE India Mechatronics · MIT Manipal',
      location: 'Manipal, India',
      period: 'Oct 2023 – Present',
      points: [
        'Managing a 200-member robotics club — workshops on PCB design, embedded systems, and kinematics',
        'Mentored 50+ students across engineering disciplines through hands-on projects and competitions',
        'Organised inter-college robotics events, technical workshops, and Mechatron at Tech Tatva 2024',
      ],
    },
    {
      role: 'Electronics Member',
